...
let mockUsers = [
  { id: 1, username: 'demo_user', created_at: '2024-01-01T10:00:00Z' },
...
let mockFavourites = [
  {
    ...
    notes: 'Classic burn spell - great for beginners',
  ...
  },
  {
    ...
    scryfall_id: 'e2ca9671-0ad9-4e39-8a7a-47cd8b7b9297',
    ability_type: 'Creature - Elf Druid',
    notes: 'Mana acceleration - very useful',
...
let mockMessages = [
  { id: 1, text: 'Welcome to Planeswalker\'s Primer!', created_at: '2024-01-01T09:00:00Z' },
  { id: 2, text: 'This is offline mode - backend is not available', created_at: '2024-01-01T09:30:00Z' }
];
...
const mockScryfallCards = [
  ...
  {
    id: 'e2ca9671-0ad9-4e39-8a7a-47cd8b7b9297',
    name: 'Llanowar Elves',
    mana_cost: '{G}',
    ...
    toughness: '1',
    image_uris: {
      normal: 'https://cards.scryfall.io/normal/front/e/2/e2ca9671-0ad9-4e39-8a7a-47cd8b7b9297.jpg'
    }
  },
  {
    ...
    toughness: '4',
    image_uris: {
      normal: 'https://cards.scryfall.io/normal/front/b/5/b5d97e72-8c85-4f1e-9a55-8e4b6c54c9b1.jpg'
    }
  },
  {
    ...
    toughness: null,
    image_uris: {
      normal: 'https://cards.scryfall.io/normal/front/c/e/ce30f926-bc06-46ee-9f35-0cdf09a67043.jpg'
    }
  }
];
...
function generateId() {
  return Math.max(...mockUsers.map(u => u.id), ...mockFavourites.map(f => f.id), 0) + 1;
}
...
export const mockApi = {
  ...
  users: {
    ...
    async update(id, userData) {
      ...
      if (mockUsers.some(u => u.username === username && u.id !== parseInt(id))) {
        throw new Error('Username already exists');
      }
  ...
  favourites: {
    ...
    async create(favouriteData) {
      await delay(250);
      const { user_id, card_name, scryfall_id, ability_type, notes } = favouriteData;
    ...
    async update(id, favouriteData) {
      await delay(200);
      const favouriteIndex = mockFavourites.findIndex(f => f.id === parseInt(id));
      if (favouriteIndex === -1) {
      ...
      mockFavourites[favouriteIndex] = {
        ...mockFavourites[favouriteIndex],
        notes: notes !== undefined ? notes : mockFavourites[favouriteIndex].notes,
        ability_type: ability_type !== undefined ? ability_type : mockFavourites[favouriteIndex].ability_type
      };
  ...
  cards: {
    async search(query) {
      ...
      const filteredCards = mockScryfallCards.filter(card =>
    ...
    async random(ability) {
      ...
      if (ability) {
        filteredCards = mockScryfallCards.filter(card =>
...
export function resetMockData() {
  ...
  mockMessages = [
    { id: 1, text: 'Welcome to Planeswalker\'s Primer!', created_at: '2024-01-01T09:00:00Z' },
    { id: 2, text: 'Mock data has been reset', created_at: getCurrentTimestamp() }
  ];
}
